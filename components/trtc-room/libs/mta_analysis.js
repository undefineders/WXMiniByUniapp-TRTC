...
function setUID() {
  try {
    var a = getRandom();
    uni.setStorageSync(MTA_CONFIG.prefix + "auid", a);
    return a;
  } catch (b) {}
}
...
function setSID() {
  try {
    var a = "s" + getRandom();
    uni.setStorageSync(MTA_CONFIG.prefix + "ssid", a);
    return a;
  } catch (b) {}
}
...
function getBasicInfo() {
  ...
  getNetworkType(function (a) {
    try {
      uni.setStorageSync(MTA_CONFIG.prefix + "ntdata", a);
    } catch (c) {}
  });
  a.ct = uni.getStorageSync(MTA_CONFIG.prefix + "ntdata") || "4g";
  return a;
}
